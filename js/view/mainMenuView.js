        ...
        return (
            <div className='middle'>
                <label className='optionGroupTitle'>
                    ...
                    <input type="radio" id='difficultyEasy' name='difficulty' className='radioDefault optionRadio' value="EASY" checked={(this.state.selectedDifficulty == 'EASY')} onChange={this.toggleDifficultyChange} /><label id='labelDifficultyEasy' htmlFor='difficultyEasy' tabIndex='0' onFocus={this.checkOnFocus} onKeyDown={onKeyDownDifficultyEasyRadio}> <span></span> EASY </label>
                    <input type="radio" id='difficultyMedium' name='difficulty' className='radioDefault optionRadio' value="MEDIUM" checked={(this.state.selectedDifficulty == 'MEDIUM')} onChange={this.toggleDifficultyChange} /><label id='labelDifficultyMedium' htmlFor='difficultyMedium' tabIndex='1' onFocus={this.checkOnFocus} onKeyDown={onKeyDownDifficultyMediumRadio}> <span></span> MEDIUM </label>
                    <input type="radio" id='difficultyHard' name='difficulty' className='radioDefault optionRadio' value="HARD" checked={(this.state.selectedDifficulty == 'HARD')} onChange={this.toggleDifficultyChange} /><label id='labelDifficultyHard' htmlFor='difficultyHard' tabIndex='2' onFocus={this.checkOnFocus} onKeyDown={onKeyDownDifficultyHardRadio}> <span></span> HARD </label>
                </label>
                <label className='optionGroupTitle'>
                    <span className='title'>Questions Amount: </span>
                    <input type="radio" id='questionsLow' name='questionsAmount' className='radioDefault optionRadio' value="30" checked={(this.state.selectedQuestionsAmount == '30')} onChange={this.toggleQuestionsAmountChange} /><label id='labelQuestionsLow' htmlFor='questionsLow' tabIndex='3' onFocus={this.checkOnFocus} onKeyDown={onKeyDownQuestionsLowRadio}> <span></span> 30 </label>
                    <input type="radio" id='questionsMiddle' name='questionsAmount' className='radioDefault optionRadio' value="60" checked={(this.state.selectedQuestionsAmount == '60')} onChange={this.toggleQuestionsAmountChange} /><label id='labelQuestionsMiddle' htmlFor='questionsMiddle' tabIndex='4' onFocus={this.checkOnFocus} onKeyDown={onKeyDownQuestionsMiddleRadio}> <span></span> 60 </label>
                    <input type="radio" id='questionsHight' name='questionsAmount' className='radioDefault optionRadio' value="90" checked={(this.state.selectedQuestionsAmount == '90')} onChange={this.toggleQuestionsAmountChange} /><label id='labelQuestionsHight' htmlFor='questionsHight' tabIndex='5' onFocus={this.checkOnFocus} onKeyDown={onKeyDownQuestionsHightRadio} > <span></span> 90 </label>
                </label>
                <label className='optionGroupTitle'>
                    <span className='title'>Target Time (minutes): </span>
                    <input type="radio" id='targetTimeLow' name='targetTime' className='radioDefault optionRadio' value="300000" checked={(this.state.selectedMaxSeconds == '300000')} onChange={this.toggleMaxSecondsChange} /><label id='labelTargetTimeLow' htmlFor='targetTimeLow' tabIndex='6' onFocus={this.checkOnFocus} onKeyDown={onKeyDownTargetTimeLowRadio}> <span></span> 5 </label>
                    <input type="radio" id='targetTimeMiddle' name='targetTime' className='radioDefault optionRadio' value="600000" checked={(this.state.selectedMaxSeconds == '600000')} onChange={this.toggleMaxSecondsChange} /><label id='labelTargetTimeMiddle' htmlFor='targetTimeMiddle' tabIndex='7' onFocus={this.checkOnFocus} onKeyDown={onKeyDownTargetTimeMiddleRadio}> <span></span> 10 </label>
                    <input type="radio" id='targetTimeHight' name='targetTime' className='radioDefault optionRadio' value="900000" checked={(this.state.selectedMaxSeconds == '900000')} onChange={this.toggleMaxSecondsChange} /><label id='labelTargetTimeHight' htmlFor='targetTimeHight' tabIndex='8' onFocus={this.checkOnFocus} onKeyDown={onKeyDownTargetTimeHightRadio}> <span></span> 15 </label>
                </label>
